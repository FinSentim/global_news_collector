...
#from .. import ChinaDailyScrapper 
...
class TestChinaDailyScrapper(unittest.TestCase):
    ...
    def test_get_article(self):
        ...
        url = "https://cn.chinadaily.com.cn/a/202201/28/WS61f3b9a8a3107be497a047ba.html"
        article = ChinaDailyScrapper.get_article(url)
        self.assertEqual(article["author"], test_article["author"])
        self.assertEqual(article["date_of_publication"], test_article["date_of_publication"])
        self.assertEqual(article["body"], test_article["body"])
        self.assertEqual(article["date_retrieved"], test_article["date_retrieved"])
        self.assertEqual(article["url"], test_article["url"])
        self.assertEqual(article["publisher"], test_article["publisher"])
